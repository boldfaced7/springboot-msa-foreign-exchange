...
class DelayFxWithdrawalCheckServiceImplTest {

    @InjectMocks
    private DelayFxWithdrawalCheckServiceImpl delayFxWithdrawalCheckService;

    @Mock
    private SendFxWithdrawalCheckRequestPort sendFxWithdrawalCheckRequestPort;
    ...
    void delayFxWithdrawalCheck() {
        // given
        Count count = new Count(2);
        Duration expectedDelay = Duration.ofSeconds(30).multipliedBy(count.value() + 1);

        // when
        delayFxWithdrawalCheckService.delayFxWithdrawalCheck(requestId, count);

        // then
        verify(sendFxWithdrawalCheckRequestPort).sendFxWithdrawalCheckRequest(
            eq(requestId), 
    ...
    void delayFxWithdrawalCheckZeroCount() {
        // given
