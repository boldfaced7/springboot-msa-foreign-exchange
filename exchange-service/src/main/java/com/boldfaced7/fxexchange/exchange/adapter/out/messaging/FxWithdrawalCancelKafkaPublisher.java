...
public class FxWithdrawalCancelKafkaPublisher implements
        CancelWithdrawalPort
{
    private static final String TOPIC_FX_WITHDRAWAL_CANCEL = "exchange-topic.fx-withdrawal.cancel";

    private final KafkaTemplate<String, String> kafkaTemplate;

    @Override
    public void cancelWithdrawal(ExchangeId exchangeId) {
        kafkaTemplate.send(TOPIC_FX_WITHDRAWAL_CANCEL, exchangeId.value());
    }
