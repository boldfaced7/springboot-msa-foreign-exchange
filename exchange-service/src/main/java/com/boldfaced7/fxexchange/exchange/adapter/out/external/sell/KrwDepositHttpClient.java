...
public class KrwDepositHttpClient implements
        RequestDepositPort,
        LoadDepositResultPort
{
    ...
    public DepositResult loadDepositResult(ExchangeId exchangeId) {
        return webClient.get()
                ...
                .retrieve()
                .bodyToMono(KrwDepositResponse.class)
                .map(KrwDepositResponse::toDepositResult)
    ...
    private record KrwDepositResponse(
            boolean success,
            String status,
            String depositId
    ) {
