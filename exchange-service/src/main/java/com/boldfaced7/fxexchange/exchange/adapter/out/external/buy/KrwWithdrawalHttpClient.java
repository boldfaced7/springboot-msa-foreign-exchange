...
public class KrwWithdrawalHttpClient implements
        ...
        LoadWithdrawalResultPort
{
    ...
    public KrwWithdrawalHttpClient(
            @Qualifier("krwWithdrawalWebClient") WebClient webClient,
    ...
    public WithdrawalResult loadWithdrawalResult(ExchangeId exchangeId) {
        return webClient.get()
                ...
                .retrieve()
                .bodyToMono(KrwWithdrawalResponse.class)
                .map(KrwWithdrawalResponse::toWithdrawalResult)
    ...
    private record KrwWithdrawalResponse(
            boolean success,
            String status,
            String withdrawalId
    ) {
